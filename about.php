...
$page_title = site_title($conn, 'About Us');
$page_description = mb_strimwidth(trim(strip_tags($about_text)), 0, 160, '…');
if ($about_image)
  $page_image = img_url($about_image);
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="value-item">
                ...
                <div>
                  ...
                  <?php if ($val['description']): ?>
                    <p><?= e($val['description']) ?></p><?php endif; ?>
                </div>
              </div>
            <?php endforeach; ?>
          </div>
        ...
        <div class="ab-card reveal reveal-delay-2">
          <div class="ab-meeting-grid">
            <div class="ab-meeting-item">
              <div class="ab-meeting-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--pink-700)"
