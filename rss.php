...
<style>
  body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;background:#fff5f9;color:#2d3436;margin:0}
  .hdr{background:linear-gradient(135deg,#8a2450,#C0396B);color:#fff;padding:48px 24px}
  .hdr .badge{display:inline-block;background:rgba(255,255,255,.15);border:1px solid rgba(255,255,255,.35);padding:4px 12px;border-radius:20px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;margin-bottom:16px}
  .hdr h1{margin:0 0 10px;font-family:Georgia,'Cormorant Garamond',serif;font-size:2rem}
  .hdr p{margin:0;opacity:.85;max-width:640px;line-height:1.6}
  .wrap{max-width:720px;margin:0 auto;padding:28px 24px 80px}
  .note{font-size:12.5px;color:#9a8f95;margin:0 0 24px;line-height:1.6;background:#fff;border:1px solid #f2e3ea;border-radius:10px;padding:14px 16px}
  .note code{background:#fdf3f7;border:1px solid #eee0e5;border-radius:5px;padding:1px 6px;word-break:break-all}
  .item{background:#fff;border-radius:14px;padding:24px;margin-bottom:18px;box-shadow:0 2px 12px rgba(0,0,0,.06)}
  .item h2{margin:0 0 8px;font-size:1.2rem;font-family:Georgia,'Cormorant Garamond',serif}
  .item h2 a{color:#8a2450;text-decoration:none}
  .item h2 a:hover{text-decoration:underline}
  .meta{font-size:12px;color:#a19499;margin-bottom:12px}
  .cat{display:inline-block;background:#fbe9f0;color:#8a2450;padding:2px 10px;border-radius:20px;font-size:10.5px;font-weight:700;letter-spacing:.03em;text-transform:uppercase;margin-right:8px}
  .desc{font-size:14px;line-height:1.75;color:#555;white-space:pre-line}
</style>
</head>
<body>
  <div class="hdr">
  ...
  <div class="wrap">
    <p class="note">This is an RSS feed, not a regular page — paste <code><?= $esc($origin . '/rss.php') ?></code> into a feed reader (Feedly, Inoreader, Outlook) to subscribe. Showing a readable preview below in the meantime.</p>
