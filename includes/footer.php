  ...
  <div class="footer-grid">
    <div class="footer-brand">
      ...
      <div class="socials" style="margin-top:20px">
        <?php if ($_fb): ?>
        <a href="<?= htmlspecialchars($_fb, ENT_QUOTES, 'UTF-8') ?>" class="social-btn" style="background:rgba(255,255,255,0.08)" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if ($_ig): ?>
        <a href="<?= htmlspecialchars($_ig, ENT_QUOTES, 'UTF-8') ?>" class="social-btn" style="background:rgba(255,255,255,0.08)" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
        ...
        <?php endif; ?>
        <?php if ($_tw): ?>
        <a href="<?= htmlspecialchars($_tw, ENT_QUOTES, 'UTF-8') ?>" class="social-btn" style="background:rgba(255,255,255,0.08)" aria-label="X" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="rgba(255,255,255,0.6)"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/></svg>
        </a>
        <?php endif; ?>
        <?php if ($_tt): ?>
        <a href="<?= htmlspecialchars($_tt, ENT_QUOTES, 'UTF-8') ?>" class="social-btn" style="background:rgba(255,255,255,0.08)" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
          <svg viewBox="0 0 24 24" fill="rgba(255,255,255,0.6)"><path d="M16.6 5.82s.51.5 0 0A4.278 4.278 0 0115.54 3h-3.09v12.4a2.592 2.592 0 01-2.59 2.5c-1.42 0-2.6-1.16-2.6-2.6 0-1.72 1.66-3.01 3.37-2.48V9.66c-3.45-.46-6.47 2.22-6.47 5.64 0 3.33 2.76 5.7 5.69 5.7 3.14 0 5.69-2.55 5.69-5.7V9.01a7.35 7.35 0 004.3 1.38V7.3s-1.88.09-3.24-1.48z"/></svg>
        </a>
        <?php endif; ?>
        <?php if ($_li): ?>
        <a href="<?= htmlspecialchars($_li, ENT_QUOTES, 'UTF-8') ?>" class="social-btn" style="background:rgba(255,255,255,0.08)" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
