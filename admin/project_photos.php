...
<div class="gallery-admin-grid">
  ...
  <div class="gallery-item-admin">
    <img src="<?= h($p['image_path']) ?>" alt="Project photo">
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="modal-body">
        ...
        <div class="form-group mb-2">
          ...
          <input type="file" id="pp_images" name="images[]" accept="image/*" multiple style="display:none" onchange="document.getElementById('pp_count').textContent = this.files.length + ' file(s) selected';">
