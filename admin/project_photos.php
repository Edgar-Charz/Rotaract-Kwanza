...
<div class="card-header card-header--standalone">
  <div>
    <a href="projects.php" class="btn btn-sm btn-secondary back-link">&larr; Back to Projects</a>
        ...
        <div class="gallery-item-info">
          ...
          <?php if (has_role('editor')): ?>
            <div class="gallery-item-actions">
              ...
              <form id="del-pp-<?= $p['id'] ?>" method="POST" class="d-inline">
                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                <input type="hidden" name="action" value="delete">
                <input type="hidden" name="id" value="<?= $p['id'] ?>">
              </form>
              <button class="btn btn-icon btn-sm btn-danger" title="Delete" aria-label="Delete" onclick="confirmDelete('del-pp-<?= $p['id'] ?>')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<?php if (has_role('editor')): ?>
  ...
  <div class="modal fade" id="reorder-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-content modal-480">
      ...
      <div class="modal-body">
        <p class="text-muted fs-12-5 mb-12px">Drag to reorder. This sets the order photos appear in on the public project page.</p>
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="modal-body">
        ...
        <div class="form-group mb-2">
          ...
          <input type="file" id="pp_images" name="images[]" accept="image/*" multiple class="hidden" onchange="renderCaptionInputs(this)">
          <p id="pp_count" class="text-muted fs-12 mt-6px"></p>
          <div id="pp_caption_list" class="mt-6px"></div>
        </div>
      </div>
      <div class="modal-footer">
