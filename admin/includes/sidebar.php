...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <a href="search.php" class="nav-item <?= active_nav('search.php') ?>">
    ...
    <div class="nav-section">
      ...
      <a href="index.php" class="nav-item <?= active_nav('index.php') ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
        Dashboard
      </a>
      <a href="reports.php" class="nav-item <?= active_nav('reports.php') ?>">
    ...
    <div class="nav-section">
      ...
      <a href="members.php" class="nav-item <?= active_nav('members.php') ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        Members
      </a>
      <a href="dues.php" class="nav-item <?= active_nav('dues.php') ?>">
    ...
    <div class="nav-section">
      ...
      <a href="team.php" class="nav-item <?= active_nav('team.php') ?>">
      ...
      <a href="team_photos.php" class="nav-item <?= active_nav('team_photos.php') ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
        Team Photos
      </a>
      <a href="leadership_history.php" class="nav-item <?= in_array(basename($_SERVER['PHP_SELF']), ['leadership_history.php', 'leadership_term.php', 'leadership_term_photos.php'], true) ? 'active' : '' ?>">
    ...
    <div class="nav-section">
      ...
      <a href="categories.php" class="nav-item <?= active_nav('categories.php') ?>">
    ...
    <div class="nav-section">
      ...
      <a href="settings.php" class="nav-item <?= active_nav('settings.php') ?>">
      ...
      <a href="activity_log.php" class="nav-item <?= active_nav('activity_log.php') ?>">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
        Activity Log
      </a>
      <?php if (has_role('super_admin')): ?>
      <a href="backup.php" class="nav-item <?= active_nav('backup.php') ?>">
