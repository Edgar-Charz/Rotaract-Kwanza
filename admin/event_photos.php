...
<div class="modal fade" id="reorder-modal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-content" style="max-width:480px">
    ...
    <div class="modal-body">
      <p class="text-muted" style="font-size:12.5px;margin-bottom:12px">Drag to reorder. This sets the order photos appear in on the public event page.</p>
    ...
    <form method="POST" enctype="multipart/form-data">
      <div class="modal-body">
        ...
        <div class="form-group mb-2">
          ...
          <input type="file" id="ep_images" name="images[]" accept="image/*" multiple style="display:none" onchange="renderCaptionInputs(this)">
          <p id="ep_count" class="text-muted" style="font-size:12px;margin-top:6px"></p>
          <div id="ep_caption_list" style="margin-top:6px"></div>
        </div>
      </div>
      <div class="modal-footer">
