    ...
    <table id="dt-perks">
      ...
      <tbody>
        <?php if ($perks): foreach ($perks as $p): ?>
            <tr>
              <td>
                <div class="icon-32-primary"><?= icon_svg($p['icon_key']) ?></div>
              </td>
              <td class="fw-bold"><?= h($p['title']) ?></td>
              <td class="text-muted text-clamp-320"><?= h($p['description'] ?? '') ?></td>
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
          ...
          <div class="form-group form-group-row pt-22px">
            <input type="checkbox" name="is_active" id="ap_active" checked class="w-auto">
            <label for="ap_active" class="fw-normal">Visible on site</label>
          </div>
        </div>
      </div>
    ...
    <form method="POST">
      <div class="modal-body">
        ...
        <div class="form-row">
          ...
          <div class="form-group form-group-row pt-22px">
            <input type="checkbox" name="is_active" id="ep_active" class="w-auto">
            <label for="ep_active" class="fw-normal">Visible on site</label>
          </div>
        </div>
      </div>
      <div class="modal-footer">
