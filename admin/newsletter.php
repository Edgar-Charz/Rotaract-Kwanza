...
<div class="card">
  <div class="card-header">
    ...
    <span class="text-muted fs-13"><?= count($subscribers) ?> subscriber<?= count($subscribers) !== 1 ? 's' : '' ?></span>
  </div>
            ...
            <td>
              <?php if (has_role('editor')): ?>
                <div class="table-actions">
                  <form id="del-sub-<?= $s['id'] ?>" method="POST" class="d-inline">
