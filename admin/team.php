  ...
  <?php if (has_role('editor')): ?>
      ...
      <div class="modal-dialog modal-content modal-sm">
        ...
        <div class="modal-body">
          <p class="text-muted fs-12-5 mb-14px">
            Copies each selected member's name, role, description, photo, email, social links, and visibility into the chosen Leadership Term. The team members themselves are unaffected.
          </p>
          ...
          <div id="bulk-archive-new-term-fields" class="hidden">
    ...
    <div class="modal fade" id="reorder-modal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-content modal-480">
        ...
        <div class="modal-body">
          <p class="text-muted fs-12-5 mb-12px">Drag to reorder. This sets each member's display order (used as a tie-breaker within the same role/tier).</p>
      ...
      <tbody>
        <?php if ($team): foreach ($team as $t): ?>
            <tr>
              ...
              <td>
                <?php if ($t['image_path']): ?>
                  <img src="<?= h($t['image_path']) ?>" class="team-avatar-img">
                <?php else: ?>
              ...
              <td><?= h($t['role']) ?></td>
              <td class="text-muted fs-12"><?= h($t['tier_label']) ?></td>
              ...
              <td>
                <div class="table-actions">
                  <button class="btn btn-icon btn-sm btn-secondary" title="View" aria-label="View" onclick="openViewModal(<?= h(json_encode($t)) ?>)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                      <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                      <circle cx="12" cy="12" r="3" />
                    </svg></button>
                  <?php if (has_role('editor')): ?>
                    <button class="btn btn-icon btn-sm btn-info" title="Edit" aria-label="Edit" onclick="openEditModal(<?= h(json_encode($t)) ?>)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M17 3a2.85 2.86 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" />
                      </svg></button>
                    <button class="btn btn-icon btn-sm btn-secondary" title="Archive to Leadership History" aria-label="Archive to Leadership History" onclick="openArchiveModal(<?= h(json_encode($t)) ?>)"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M21 8v13H3V8" />
                        <path d="M1 3h22v5H1z" />
                    ...
                    <button class="btn btn-icon btn-sm btn-danger" title="Delete" aria-label="Delete" onclick="confirmDelete('del-t-<?= $t['id'] ?>')"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div class="modal-body">
        ...
        <div class="form-group mb-2">
          ...
          <div class="image-field">
            ...
            <input type="file" id="at_image" name="image" accept="image/*" class="hidden" onchange="previewImage(this,'add-team-prev')">
            <div class="thumb-col">
        ...
        <div class="form-row">
          <div class="form-group"><label>Term <span class="text-muted fw-normal">(e.g. 2025&ndash;2026)</span></label><input type="text" name="term" placeholder="2025–2026"></div>
        ...
        <div class="form-group form-group-row">
          <input type="checkbox" name="is_active" id="at_active" checked class="w-auto">
          <label for="at_active" class="fw-normal">Show on public team page</label>
        </div>
      </div>
      <div class="modal-footer">
      ...
      <div class="modal-body">
        ...
        <div class="form-group mb-2">
          ...
          <div class="image-field">
            ...
            <input type="file" id="et_image" name="image" accept="image/*" class="hidden" onchange="previewImage(this,'edit-team-prev')">
        ...
        <div class="form-row">
          <div class="form-group"><label>Term <span class="text-muted fw-normal">(e.g. 2025&ndash;2026)</span></label><input type="text" name="term" id="et_term" placeholder="2025–2026"></div>
        ...
        <div class="form-group form-group-row">
          <input type="checkbox" name="is_active" id="et_active" class="w-auto">
          <label for="et_active" class="fw-normal">Show on public team page</label>
        </div>
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog modal-content modal-460">
    ...
    <form method="POST">
      <div class="modal-body">
        ...
        <p class="text-muted fs-12-5 mb-14px">
          Copies <strong id="ar_member_name"></strong>'s name, role, description, photo, email, social links, and visibility into a Leadership History term. The team member itself is unaffected.
        </p>
        <div class="form-group mb-2">
          <label>Term</label>
        ...
        <div id="ar_new_term_fields" class="hidden">
        ...
        <div class="form-group"><label>Description</label><textarea name="description" id="ar_description" class="mh-70"></textarea></div>
      </div>
      <div class="modal-footer">
  ...
  function openViewModal(t) {
    ...
    <div class="view-avatar-row">
      ...
      <div>
        ...
        <div class="text-muted fs-13">${esc(t.role)}</div>
        <span class="badge ${t.is_active == 1 ? 'badge-approved' : 'badge-rejected'} mt-4px">
