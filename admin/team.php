...
<div class="card">
  ...
  <div class="table-wrap">
    <table id="dt-team">
      <thead>
        <tr><th>Photo</th><th>Name</th><th>Role</th><th>Email</th><th>Order</th><th>Visible</th><th>Actions</th></tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>
            <div class="table-actions">
              <button class="btn btn-sm btn-secondary" onclick="openViewModal(<?= h(json_encode($t)) ?>)">View</button>
              <button class="btn btn-sm btn-info" onclick="openEditModal(<?= h(json_encode($t)) ?>)">Edit</button>
              <form id="del-t-<?= $t['id'] ?>" method="POST" style="display:inline">
                <input type="hidden" name="csrf_token" value="<?= csrf_token() ?>">
                <input type="hidden" name="action" value="delete">
                <input type="hidden" name="id" value="<?= $t['id'] ?>">
              </form>
              <button class="btn btn-sm btn-danger" onclick="confirmDelete('del-t-<?= $t['id'] ?>')">Delete</button>
            </div>
          </td>
        </tr>
