...
<head>
  ...
  <style>
    ...
    .cat-btn:hover,
    .cat-btn.active {
      background: var(--primary, #C0396B);
      color: #fff;
      border-color: var(--primary, #C0396B);
    }
    ...
    .news-card:hover {
      ...
      box-shadow: 0 8px 30px rgba(192, 57, 107, 0.13);
    }
...
<body>
  ...
  <div class="news-hero">
    <div class="container">
      ...
      <p style="max-width:560px;margin:12px 0 0;color:rgba(255,255,255,0.75);font-size:14.5px;line-height:1.6"><?= e($news_intro) ?></p>
    </div>
  </div>
